...
template <typename T__> 
struct QueryT{
    FreshVamana::Consts::queryType type = FreshVamana::Consts::queryType::search_q; // have to overwrite(INITIALIZE) this at the time of instantiation of the query struct
    FreshVamana::Consts::dtype_g *vec_elements = nullptr; // (default) Vector of 128 entries each of data_type= float
};
